 ...
 *  Two states and one action [offensive - trackfire, defensive -moveLeft, adjustAngleGun, action]
	...
	Input Signals:
	getBearing, getGunHeading  - these two combine for bearingFromGun
	getDistance
 ...
 * @class: EECE 592 
 * @purpose: Create LUT to train robot in robocode. Will be replaced with a neural net in part 3.  
*/
package MyRobots;
...
public class braveDodget extends AdvancedRobot implements LUTInterface{
	/**
	 * Definitions
	 */
    ...
    //information for saving the game
...
//        }
    ...
    /**
     * @name:		importLUTData
     * @author:		95% sittingduckbot sample robot
    ...
    public boolean importLUTData(boolean repeatFlag){
        if (repeatFlag == false) {
            try {
                ...
                out.println("Something done wrong (Error0x01 error in file reading)");
            } 
            catch (NumberFormatException e) {
                // Error0x02: error in int conversion
                out.println("Something done wrong2 (Error0x02 error in int conversion)");
            }
        }
    ...
    /**
     * @name:		exportLUTData
     * @author:		99% sittingduckbot sample robot
        ...
        if (repeatFlag == true) {
            ...
            try {
                ...
                if (w.checkError()) {
                    ...
                    out.println("Something done wrong (Error0x03 cannot write)");
                }
            } catch (IOException e) {
    ...
    /**
     * @name:		importWinLose()
     * @purpose: 	1. Import win/loss data from file. 
     * @param: 		none
     * @return:		void
     */
    ...
    /**
     * @name:		exportWinLose()
     * @purpose: 	1. Export win/loss data into text file. 
     * @param: 		winOrLoss data 
     * @return:		void
     */
