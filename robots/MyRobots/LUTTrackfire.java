...
public class LUTTrackfire extends AdvancedRobot implements LUTInterface{
    ...
    private static final int enemyBearingFromGun_sine = 3; 						// 360 degrees / 4 for sine 
    private static final int enemyBearingFromGun_cosine = 3; 					// 360 degrees / 4 for cosine
    private static final int enemyFiringAction = 3;  							//fire close, mid, far. 
    private static final int enemyVelocity = 2; 								//velocitiy is close, mid, far 
    private static final int enemyDistance_states = 3;							//discretize distance into 10 
    private static final int myEnergy_states = 3;								//discretize energy into 10 
...
//        learningLoop(); //?Joey: why is learningLOop called here? for terminal reward? causes export errors
	...
	*/     
    ...
    public void generateCurrentStateVector(){
    	...
    	currentStateActionVector[1]  = (int) enemyBearingFromHeading;
    	if (currentStateActionVector[1] < 0){
    		currentStateActionVector[1] = 0; 
    	}
		else if (currentStateActionVector[1] > 100){
    	...
    	currentStateActionVector[2]  = (int) enemyBearingFromGun;
    	if (currentStateActionVector[2] < 0){
    		currentStateActionVector[2] = 0; 
    	}
		else if (currentStateActionVector[2] > 100){
    	...
    	//Dimension 3: input: enemyFiringAction?!?!?!?! what the heck is this? 
    		currentStateActionVector[3] = (int) myHeading;
        	if (currentStateActionVector[3] < 0){
        		currentStateActionVector[3] = 0; 
        	}
    		else if (currentStateActionVector[3] > 100){
    		...
    		if (currentStateActionVector[4]<2){
    		...
    		//Dimension 5: input: distance. 
    		if (currentStateActionVector[5] < 200){
    			currentStateActionVector[5] = 0; 
    		}
    		else if (currentStateActionVector[5] < 400){
    		...
    		//Dimension 6: input: myEnergy_states
