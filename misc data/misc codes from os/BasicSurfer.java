...
public class BasicSurfer extends AdvancedRobot {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        //getting lateralVelocity of enemy(?)bot
        ...
        _surfDirections.add(0,
            new Integer((lateralVelocity >= 0) ? 1 : -1)); //why put in new Integer here
        _surfAbsBearings.add(0, new Double(absBearing + Math.PI)); //adds pi to do something, probably avoid neg absBearings?
 
 
        double bulletPower = _oppEnergy - e.getEnergy(); //keeping track of opponent energy, consider that wall hitting is one.
        if (bulletPower < 3.01 && bulletPower > 0.09
            ...
            ew.direction = ((Integer)_surfDirections.get(2)).intValue(); //having 2 here hmm?
